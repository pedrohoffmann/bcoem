...
if ($msg == "227") $output = sprintf("<strong> O CPF não foi encontrado na base de associados ACervA.</strong> Verifique se digitou seu CPF corretamente, sem pontos ou hífens, ou procure a sua ACervA. Concurso exclusivo para associados ACervA.");
