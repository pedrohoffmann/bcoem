...
<!-- Begin the Form -->
	...
	<div class="form-group"><!-- Form Group REQUIRED Text Input -->
		<label for="" class="col-lg-3 col-md-3 col-sm-4 col-xs-12 control-label">CPF</label>
		<div class="col-lg-9 col-md-9 col-sm-8 col-xs-12">
			<div class="input-group has-warning">
				<span class="input-group-addon" id="cpf-addon1"><span class="fa fa-user"></span></span>
				<!-- Input Here -->
				<input class="form-control" name="brewerCPF" id="brewerCPF" type="text" placeholder="" value="<?php if (($msg > 0) && (isset($_COOKIE['brewerCPF']))) echo $_COOKIE['brewerCPF']; ?>" required>
